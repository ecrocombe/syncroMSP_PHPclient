# Swagger\Client\NewTicketFormApi
...
$apiInstance = new Swagger\Client\Api\NewTicketFormApi(
...
$id = 56; // int | 
$body = new \Swagger\Client\Model\IdProcessFormBody(); // \Swagger\Client\Model\IdProcessFormBody | 
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  |
 **body** | [**\Swagger\Client\Model\IdProcessFormBody**](../Model/IdProcessFormBody.md)|  | [optional]
