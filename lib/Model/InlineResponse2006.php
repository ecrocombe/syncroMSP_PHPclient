...
class InlineResponse2006 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['wiki_page'] = isset($data['wiki_page']) ? $data['wiki_page'] : null;
    }
    ...
    {
        return $this->container['wiki_page'];
    }
    ...
    {
        $this->container['wiki_page'] = $wiki_page;
