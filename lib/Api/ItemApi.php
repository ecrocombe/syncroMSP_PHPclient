...
class ItemApi
{
     ...
     *
     * @param  bool $completed Returns only completed part orders (optional)
     ...
     * @return void
     */
    public function itemsGet($completed = null, $query = null, $page = null)
    {
        $this->itemsGetWithHttpInfo($completed, $query, $page);
    }
     ...
     */
    public function itemsGetWithHttpInfo($completed = null, $query = null, $page = null)
    {
        $returnType = '';
        $request = $this->itemsGetRequest($completed, $query, $page);
     ...
     */
    public function itemsGetAsync($completed = null, $query = null, $page = null)
    {
        return $this->itemsGetAsyncWithHttpInfo($completed, $query, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsGetAsyncWithHttpInfo($completed = null, $query = null, $page = null)
    {
        $returnType = '';
        $request = $this->itemsGetRequest($completed, $query, $page);
     ...
     */
    protected function itemsGetRequest($completed = null, $query = null, $page = null)
    {
