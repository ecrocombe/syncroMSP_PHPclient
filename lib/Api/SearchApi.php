...
class SearchApi
{
     ...
     *
     * @param  int $query Search query (optional)
     *
    ...
    {
        $this->searchGetWithHttpInfo($query);
    }
     ...
     */
    public function searchGetWithHttpInfo($query = null)
    {
        $returnType = '';
     ...
     */
    public function searchGetAsync($query = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchGetAsyncWithHttpInfo($query = null)
    {
        $returnType = '';
        $request = $this->searchGetRequest($query);
     ...
     */
    protected function searchGetRequest($query = null)
    {
